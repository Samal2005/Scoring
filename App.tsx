    ...
    <HashRouter>
      <div className="min-h-screen flex flex-col relative overflow-hidden bg-[#050b18]">
        ...
        <main className="flex-grow max-w-7xl mx-auto w-full p-6 relative z-10">
          <Routes>
            <Route path="/" element={<Dashboard teams={teams} sessions={sessions} />} />
            <Route path="/scan" element={<Scanner teams={teams} onAddSession={addSession} />} />
            <Route path="/score/:sessionId" element={<ScoringView config={config} sessions={sessions} onUpdateSession={updateSession} teams={teams} />} />
            <Route path="/leaderboard" element={<Leaderboard teams={teams} sessions={sessions} config={config} />} />
            <Route path="/settings" element={<Settings config={config} onUpdateConfig={setConfig} onReset={resetAllData} teams={teams} onUpdateTeams={setTeams} />} />
          </Routes>
        </main>
