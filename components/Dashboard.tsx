...
const Dashboard: React.FC<DashboardProps> = ({ teams, sessions }) => {
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-[10px] font-bold text-slate-600 uppercase tracking-widest">Active Sync</span>
          </div>
        ...
        <section>
          ...
          <div className="glass-dark rounded-3xl border border-white/5 overflow-hidden">
            ...
            {completedSessions.length > 5 && (
              <Link to="/leaderboard" className="block text-center py-4 bg-white/[0.03] text-cyan-400 text-[10px] font-black uppercase tracking-[0.4em] hover:bg-cyan-500 hover:text-white transition">
                Access All Archives
              </Link>
            )}
          </div>
